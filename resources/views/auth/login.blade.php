...
<div id="copy"><a href="https://twitter.com/igcorreia" target="_blank">Crafted by: <b>@igcorreia</b><br/>Searching for a Dribbble invite :)</a></div>
<div class="mask">
    <div class="modal">
        <div class="circle" style="background: url(&quot;https://s3-us-west-2.amazonaws.com/s.cdpn.io/9589/profile/profile-512_1.jpg&quot;);"></div>
        <div class="login" >
            <h1><img src="img/logo.png" alt="SmartAdmin"></h1>
            <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                {{ csrf_field() }}
                <input id="email" type="email"  name="email" placeholder="Ingrese su usuario" value="{{ old('email') }}" required autofocus>
...
<div class="vertical vertical9">
    ...
    <div class="horizontal horizontal930" style="background: url(&quot;//lorempixel.com/200/200/sports/3&quot;);"></div>
