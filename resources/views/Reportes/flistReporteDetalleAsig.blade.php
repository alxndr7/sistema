...
@section('content')
    ...
    <div id="main" role="main">
        ...
        <div id="ribbon">
            ...
            <!-- breadcrumb -->
            <ol class="breadcrumb">
                <li>Reportes</li><li>Calculo de Detalle de Asignación</li>
            </ol>
            <!-- end breadcrumb -->
        ...
        <!-- NEW WIDGET START -->
            <article class="col-sm-12 col-md-6 col-lg-12">
                <div class="row">
                    <label class="col-lg-2" style="text-align: right"> Fecha inicio:</label>  <input type="date" id="fecha_inicio">
                </div>
                <div class="row">
                    <label class="col-lg-2" style="text-align: right"> Fecha Fin:</label>  <input type="date" id="fecha_fin">
                </div>
                <div class="row">
                    <label class="col-lg-2" style="text-align: right"> </label>  <input class="btn btn-labeled btn-primary" type="button" id="generar" value="Generar" onclick="generar_reporte_detallado();">
                </div>
