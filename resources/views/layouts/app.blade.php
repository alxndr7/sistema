<!DOCTYPE html>
<html lang="{{ app()->getLocale() }}" style="background-image: url(&quot;img/pattern/graphy.png&quot;);">
<head>
    <meta charset="utf-8">
...
-->
<body class="desktop-detected menu-on-top  container  pace-done smart-style-2">
...
<header id="header">
    ...
    <div class="project-context hidden-xs" style="padding-top: 4px">
        <span class="label" style="padding-top: 0px"><h5><strong>Hola {{Auth::user()->name}}</strong></h5></span>
                ...
                <ul class="dropdown-menu pull-right">
                    ...
                    <li>
                        <form id="logout_form" method="POST" action="{{route('logout')}}">
                            {{csrf_field()}}
                            <a href="javascript:void(0);" onclick="document.getElementById('logout_form').submit();" class="padding-10 padding-top-5 padding-bottom-5"><i class="fa fa-sign-out fa-lg"></i> <strong><u>S</u>alir</strong></a>
                        </form>
                    </li>
                </ul>
            </li>
